...
class SerperClient:
    ...
    def __init__(self):
        ...
        if not self.api_key:
            ...
            logger.info("✅ SerpWow client initialized")
    ...
    async def search_shopping_products(self, query: str, store_name: str = None, location: str = "United States") -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.warning("⚠️ Invalid Serper API key - using demo mode")
                return self._get_demo_shopping_results(query, store_name)
            else:
    ...
    async def search_product_images(self, query: str, store_name: str = None) -> List[str]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.warning("⚠️ Invalid Serper API key - using demo mode for images")
                return self._get_demo_image_results(query)
            else:
