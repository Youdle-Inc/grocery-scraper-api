...
class ExaPyClient:
    ...
    def search_grocery_products(
        ...
        # Keep options minimal to satisfy SDK validation; domain/text filters can be applied later
        # If you want domain constraints, consider embedding in the query string instead.
