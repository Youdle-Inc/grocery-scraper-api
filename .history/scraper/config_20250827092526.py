...
# Canonical chain IDs we care about for aggregation
CANONICAL_STORES = [
    "walmart", "kroger", "costco", "albertsons", "ahold_delhaize", "publix",
    "heb", "aldi", "sams_club", "target", "whole_foods", "meijer", "winco",
    "bjs", "dollar_general", "dollar_tree", "trader_joes", "hy_vee", "wegmans",
    "sprouts", "giant_eagle", "price_chopper", "cash_saver", "south_point_grocery",
    "high_point_grocery", "rs_market", "miss_cordelias"
]

# Aliases to canonical chain IDs
STORE_ALIASES = {
    # Albertsons family
    "safeway": "albertsons",
    "vons": "albertsons",
    "jewel": "albertsons",
    "jewel_osco": "albertsons",
    # Ahold Delhaize family
    "food_lion": "ahold_delhaize",
    "giant": "ahold_delhaize",
    "harris_teeter": "ahold_delhaize",
    "hannaford": "ahold_delhaize",
    "stop_and_shop": "ahold_delhaize",
    "stop_n_shop": "ahold_delhaize",
    # Club / others
    "bj's": "bjs",
    "bjs_wholesale": "bjs",
