        ...
        for section in sections:
            ...
            for line in lines:
                ...
                if line.startswith('ADDRESS:') and current_store:
                    ...
                    if address and address != '[Complete street address with city, state, zip]' and not address.startswith('-'):
                ...
                if line.startswith('SERVICES:') and current_store:
                    ...
                    if services_text != '[comma-separated list: delivery, pickup, curbside, in-store]':
                ...
                if line.startswith('WEBSITE:') and current_store:
                    ...
                    if website and website != '[full URL if available, or "N/A"]' and website != 'N/A':
                        if not hasattr(current_store, 'website'):
                ...
                if line.startswith('STATUS:') and current_store:
                    ...
                    if status and status != '[open/closed/temporarily closed]':
